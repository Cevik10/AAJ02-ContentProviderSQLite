...
public class ArtContentProvider extends ContentProvider {
    ...
    static final String PROVIDER_NAME = "com.hakancevik.artbookcontentprovidersqlite.ArtContentProvider";
    static final String URL = "content://" + PROVIDER_NAME + "/arts";
    static final Uri CONTENT_URI = Uri.parse(URL);

    static final String NAME = "name";
    static final String ARTIST_NAME = "artistName";
    static final String ART_YEAR = "artYear";
    ...
    // sınıftan herhangi bir şeye ulaşıldığında öncelikle burası kullanılır.
    static {
    ...
    static final String CREATE_DATABASE_TABLE = "CREATE TABLE " + ARTS_TABLE_NAME + "(name TEXT NOT NULL, " + "artistName TEXT NOT NULL, " + "artYear TEXT NOT NULL, " + "image BLOB NOT NULL);";
